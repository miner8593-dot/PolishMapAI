...
0x51 0x0 2 0xDAE5E3 none none black white Font0 -1/none x x 14
0x80 0x0 -2 black none none black white Font0 -1/none x x 14
}
polylines {
ltgray
...
def test_load_navitel_ns2_cartographic_tables(tmp_path: Path):
    ...
    marsh=MpDocument.from_bytes(b"[POLYGON]\r\nType=0x51\r\nData0=(1,1),(1,2),(1,1)\r\n[END]\r\n").objects()[0]
    text=MpDocument.from_bytes(b"[POLYGON]\r\nType=0x80\r\nData0=(1,1),(1,2),(1,1)\r\n[END]\r\n").objects()[0]
